...
public class LaboratorioMysqlDaoImpl implements DAOLaboratorio {
    ...
    private String vw_lab = "{call ps_laboratorio_bs(?,?,?)}";
    ...
    public List<Laboratorio> getAll() throws DAOException {
        ...
        try {
            ...
            while (rs.next()) {
                lista.add(new Laboratorio(rs.getInt("id"), rs.getString("nombre")));
            }
    ...
    @Override
    public Laboratorio getOne(Integer o) throws DAOException {
    ...
    public List<Laboratorio> vw_laboratorio(int ini, int lim, String value) throws DAOException{
        ...
        try {
            ...
            while (rs.next()) {
                Laboratorio lab = new Laboratorio(rs.getInt("id"), rs.getString("nombreLaboratorio"));
                list.add(lab);
            }
