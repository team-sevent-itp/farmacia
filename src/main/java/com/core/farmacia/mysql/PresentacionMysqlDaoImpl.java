...
public class PresentacionMysqlDaoImpl implements DAOPresentacion {
    ...
    private String vw_present = "{call ps_presentacion_bs(?,?,?)}";
    ...
    public List<Presentacion> getAll() throws DAOException {
        ...
        try {
            ...
            while (rs.next()) {
                lista.add(new Presentacion(rs.getInt("id"), rs.getString("nombre")));
            }
    ...
    @Override
    public Presentacion getOne(Integer o) throws DAOException {
        ...
        try {
            ...
            rs = stact.executeQuery();
            if (rs.next()) {
                presentacion = new Presentacion(rs.getInt("id"), rs.getString("nombre"));
            }
    ...
    public List<Presentacion> vw_presentacion(int ini, int lim, String value) throws DAOException{
        ...
        try {
            stact = conn.prepareCall(vw_present);
            stact.setInt(1, ini);
            stact.setInt(2, lim);
            ...
            while (rs.next()) {
                Presentacion present = new Presentacion(rs.getInt("id"), rs.getString("nombrePresentacion"));
                list.add(present);
            }
